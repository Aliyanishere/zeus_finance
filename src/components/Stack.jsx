        ...
        <div className='bg_hero2'>
            ...
            <div className="container hero_text ">
                <div className="row    mx-0">
                    ...
                    <div className="col-lg-8 mt-5 hero_text heading_font1">
                        <h1 className="text-warning mt-4 fw-bolder ">NFT Staking</h1>
                        <p className="text-white fs-4">STAKE YOUR ZEUS FINANCE NFTs FOR AN APR BOOST</p>
                    </div>
                </div>
                <div className="row">
                    <div className="row mx-0 content_1">
                        <div style={{ marginTop: '-5px' }} className="col-lg-5 d-flex justify-content-center align-itmes-center border_1  ">
            ...
            {/* HERO BACKFROUND END */}
            <section className="stack_bg_image">
                    ...
                    <div className="container  space_1 d-flex justify-content-center">
                        <div className="row mx-0 my-5">
                            <div className="col-lg-4 p-lg-4 pt-5 p-3 col-12 my-5 d-flex justify-content-center">
                                <div className="card-2 d-flex flex-column align-items-center justify-content-end ">
                                    <a data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo" href>
                                        <img width="130px" src={plus1} className="card-image" loading="lazy" />
                                    </a>
                                    <br />
                                    <span className="fw-bolder fs-3 text-warning text-center">STAKE YOUR NFT</span>
                                    <br />
                                    <br />
                                </div>
                            </div>
                ...
                {/* Second Section End */}
                {/* Third Section Start */}
                <section className="  polygone_image2">
                    <div className="container  ">
                        <div className="row mx-0 cards_2 ">
                            <div className="col-lg-2" />
                            <div className="col-lg-4 p-lg-4 pt-5 p-3 col-12 my-5 mb-5  d-flex justify-content-center">
                                <div className="card-2 d-flex flex-column align-items-center justify-content-end ">
                                    <a data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo" href>
                                        <img width="130px" src={plus1} className="card-image" loading="lazy" />
                                    </a>
