...
import zeus from '../assets/images/_ZEUS.jpg';
import z_share from '../assets/images/_Zshare.jpg';
import z_bond from '../assets/images/_ZBOND.jpg';
        ...
        <div className="bg_hero2">
            ...
            <div className="container hero_text ">
                <div className="row    mx-0">
                    ...
                    <div className="col-lg-8 mt-5 hero_text">
                        <h1 className="text-warning mt-5">WELCOME TO ZEUS FINANCE</h1>
                        <p className="text-white fs-4">The first algorithmic stablecoin on Binance Smart Chain, pegged to the price of 0.01 BNB via seigniorage</p>
                    </div>
                </div>
                <div className="row">
            ...
            <section className="second_bg_image">
                ...
                <section className="polygone_image">
                    <div className="container bg-Second second_section my-5 ">
                        <div className="row mx-0 justify-content-center">
                            <div className="col-lg-4 mt-5 text-center">
                                <h2 className="text-warning">Total Valued Locked</h2>
                                <h4 className="text-white">$0</h4>
                            </div>
                            <div className="col-lg-2 px-1  mt-5 ">
                                <Link to='/panthen'>
                                    <a className="btn btn-warning fs-4 w-100  border_Left" href="">Stack Now <i className="fas fa-arrow-right fs-6" /></a>
                                </Link>
                            </div>
                            <div className="col-lg-2 px-1 mt-5 ">
                                <Link to='/Mount-olympus'>
                                    <a className="btn btn-light fs-4 w-100" target="blank" href="">Farm Now</a>
                                </Link>
                            </div>
                            <div className="col-lg-2 px-1 mt-5 ">
                                <a className="btn btn-light fs-4 w-100" href>Buy Zbond </a>
                            </div>
                            <div className="col-lg-2 px-1 mt-5 ">
                                <a className="btn btn-warning fs-4 w-100 border_Right" href>Buy Zshare </a>
                            </div>
                        </div>
                    </div>
                    <div className="container  space_1 d-flex justify-content-center">
                        <div className="row mx-0 my-5">
                            <div className="col-lg-4 p-lg-4 pt-5 p-3 col-12 my-5 d-flex justify-content-center">
                                <div className="card-1 d-flex flex-column align-items-center justify-content-end ">
                                    <img style={{ borderRadius: '50%', height: '180px' }} src={zeus} className="card-image" loading="lazy" />
                                    <span className="fw-700 fs-4 text-warning text-center">ZEUS</span>
                                    <span className="fw-300 fs-5 text-white text-center "> Current Price</span>
                                    <span className="fw-600 fs-5 text-warning text-center">0 BNB</span>
                                    <span className="fw-300 fs-6 text-white text-center "> $0</span>
                                    <span className="fw-300 fs-6 text-white text-center pb-3"> Market Cap: $0 <br /> Circulating  Supply: $0 Total <br /> Supply: $0</span>
                                </div>
                            </div>
                            <div className="col-lg-4 p-lg-4 pt-5 p-3 col-12 my-5  d-flex justify-content-center">
                                <div className="card-1 d-flex flex-column align-items-center justify-content-end ">
                                    <img style={{ borderRadius: '50%', height: '180px' }} src={z_share} className="card-image" loading="lazy" />
                                    <span className="fw-700 fs-4 text-warning text-center">Zshare</span>
                                    <span className="fw-300 fs-5 text-white text-center "> Current Price</span>
                                    <span className="fw-600 fs-5 text-warning text-center">0 BNB</span>
                                    <span className="fw-300 fs-6 text-white text-center "> $0</span>
                                    <span className="fw-300 fs-6 text-white text-center pb-3"> Market Cap: $0 <br /> Circulating  Supply: $0 Total <br /> Supply: $0</span>
                            ...
                            <div className="col-lg-4 p-lg-4 pt-5 p-3 col-12 my-5   d-flex justify-content-center">
                                <div className="card-1 d-flex flex-column align-items-center justify-content-end ">
                                    <img style={{ borderRadius: '50%', height: '180px' }} src={z_bond} className="card-image" loading="lazy" />
                                    <span className="fw-700 fs-4 text-warning text-center">Zbond</span>
                                    <span className="fw-300 fs-5 text-white text-center "> Current Price</span>
                                    <span className="fw-600 fs-5 text-warning text-center">0 BNB</span>
                                    <span className="fw-300 fs-6 text-white text-center "> $0</span>
                                    <span className="fw-300 fs-6 text-white text-center pb-3"> Market Cap: $0 <br /> Circulating  Supply: $0 Total <br /> Supply: $0</span>
